...
namespace Content.Shared.DNA
{
    ...
    public sealed class DNAConsoleBoundUserInterfaceState : BoundUserInterfaceState
    {
        ...
        public DNAConsoleBoundUserInterfaceState(string? scannerBodyInfo, string? cloningBodyInfo, bool mindPresent, ClonerStatus cloningStatus, bool scannerConnected, bool scannerInRange, bool clonerConnected, bool clonerInRange)
        {
